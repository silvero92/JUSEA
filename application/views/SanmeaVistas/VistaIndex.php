    ...
    <div class="article-list">
        ...
        <div class="container">
            ...
            <div class="intro" align="center">
                ...
                <img src="<?= base_url('img/EA.png') ?>" class="img-fluid" />
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-3 item" align="center">
                ...
                <div class="col-sm-9 col-md-3 item" align="center" >
                    <button type="button" class="btn btn-light shadow-lg p-3 mb-1 bg-white rounded" data-toggle="modal" data-target="#var2" onclick=" location.href='<?= base_url('SanmeaControlador/BienyEstado')?>' ">
                ...
                <div class="col-sm-9 col-md-3 offset-lg-0 item" align="center">
                    ...
                    <h3 class="name">Informe por Accidente/
                    Enfermedad</h3>
