        ...
        <nav class="navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="col-9" align="right">
                <label class="text-light">
                    <h5><strong>Actuación Bienes del Estado</strong></h5></a>
                </label>
            </div>
...
<!-             INFORMACION NOTA CABECERA                                                                       ->
                <div class="tab-pane fade show active" id="s1" role="tabpanel" aria-labelledby="list-home-list">
                    ...
                    <h4 align="center"><br>INFORMACION DE NOTA CABECERA</h4><br>
                    <!-1ER VARIABLE->
                    <div class="row">
                        <div class="col-3">
                            <label for="var11">C.E</label>
                        </div>

                        <div class="col-9">
                            <input type="text" class="form-control opacity" name="ExpLetraNota" id="ExpLetraNota" placeholder="Ingrese C.E" required>
                    ...
                    <div class="row">
                        ...
                        <div class="col-9">
                            <input type="number" class="form-control" name="expNumNota" id="expNumNota" placeholder="Nro Exp" required>
                            <div class="invalid-feedback">
                            ...
                            <div>
                                    <button type="submit" class="btn btn-primary" align="left" href="#s2">
                                     Siguiente
                            </button><br><br>
